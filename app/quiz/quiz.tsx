...
const ControllerButton = ({questionNum, questionCap, answers, question, navigate, questions}: {questionNum: number, questionCap: number, answers: {[id: number]: string}, question: Question, navigate: NavigateFunction, questions: Questions}) => {
  if(questionNum === questionCap) {
    return(
      <button className="next-button" onClick={() => answers[question.id] === undefined ? null : navigate('/routine', { replace:true, state: {answers: answers, questions: questions} })}>Discover your results</button>
    );
  }else {
    return(
      <button
      ...
      <div className="quiz-wrapper">
        <div className="quiz-container">
          ...
          <div className="control-module">
            ...
            <ControllerButton answers={props.answers} navigate={navigate} question={question} questionNum={questionNum} questionCap={props.questionEntity.questions.length} questions={props.questionEntity} />
          </div>
        </div>
